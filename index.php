...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #00838f cyan darken-1 z-depth-5">
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span>TSF BANK</b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span></h2>
  </div>
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust"src="./images/bank.png"width="50" height="180">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="./images/customer.png"width="80" height="180">
            </div>
            <br />

            <h5><b>Welcome to TSF Bank !</b></h5>
            <br />
            <p class="#00838f cyan darken-1"><br /></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>© 2021 Made by Anugya Pandey</b></h6>
